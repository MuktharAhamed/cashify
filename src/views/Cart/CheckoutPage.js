...
import {NavShippingAddress} from 'app-constants/Navigations';
...
const CheckoutPage = props => {
  const {
    ...
    loading,
    data: LastCheckout,
  } = useQuery(lastIncompleteCheckout, {
    ...
    <>
      <View style={{backgroundColor: '#f8f6f6', flexDirection: 'column'}}>
        ...
        <FlatList
          ...
          renderItem={({item, index}) => <CartList item={item} index={index} />} //method to render the data  in the way you want using styling u need
          horizontal={false}
