...
import {  SafeAreaView, Dimensions, StyleSheet,ScrollView, View, TouchableOpacity, LayoutAnimation, Text, UIManager} from 'react-native';
...
const ProductDetailPage = ({route, navigation}) => {
  ...
  return (
    ...
    <View style={styles.container}>
          <ScrollView>
            <Slider
                data={[
                  ...
                  {
                    image: require('app-assets/slide3.webp')
                  },
                  {
                    image: require('app-assets/slide4.webp')
                  },
                  {
                    image: require('app-assets/slide5.webp')
                  },
                ]}
                timer={2000}
                imageKey={'image'}
        ...
        <View>
            <TouchableOpacity style={styles.accordionRow} onPress={()=>toggleExpand('SIZE')}>
                <Text style={styles.accordionTitle}>SIZE</Text>
                <Icon name={expandedState.SIZE ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={30} color={'#A9A9A9'} />
            </TouchableOpacity>
       ...
       <View>
            <TouchableOpacity style={styles.accordionRow} onPress={()=>toggleExpand('COLOR')}>
                <Text style={styles.accordionTitle}>COLOUR</Text>
                <Icon name={expandedState.COLOR ? 'keyboard-arrow-up' : 'keyboard-arrow-down'} size={30} color={'#A9A9A9'} />
            </TouchableOpacity>
            <View style={styles.accordionParentHr}/>
            {
                expandedState.COLOR &&
       ...
       <View>
            <TouchableOpacity style={styles.accordionRow} onPress={()=>toggleExpand('GRADE')}>
